...
#else
            MessageBox.Show(msg, "BTFP Video Encoding Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
#endif
        }
...
#else
            MessageBox.Show(string.Format("{0}. Details: {1}", msg, ex.Message), "BTFP Video Encoding Error",
...
#else
            MessageBox.Show(ex.Message, "BTFP Video Encoding Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
#endif
        }
