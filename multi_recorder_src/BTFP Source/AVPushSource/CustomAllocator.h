...
#pragma once
#include <InitGuid.h>
#include "AVPushInterfaces_h.h"
#include "dispatch.h"	// BaseIDispatch implementation.

// -------------------------------------------------------------------------
class CCustomAllocator : public CBaseAllocator
						, public IAVPushSource
						, public IAVPushSource2
						, public IAVPushSource3
{
public:
	...
	STDMETHODIMP GetFrameBufferEx(unsigned char** ppBuffer, unsigned long* pSize);
	STDMETHODIMP DeliverEx(unsigned char* pBuffer, unsigned long cbSize);
