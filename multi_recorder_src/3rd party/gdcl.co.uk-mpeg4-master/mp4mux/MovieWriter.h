...
public:
	...
	void NotifyCheckQueues();	
	bool CheckQueuesSync();
...
private:
	...
	std::atomic<bool> notifyCondition;
	std::atomic<bool> workerThreadEndRequested;
